...
const ViewMedia = () => {
  ...
  let bannerPath =
    media.media_type === "movie" && media?.backdrop_path.split("/");
  let bannerUrl = `https://image.tmdb.org/t/p/original/${
    bannerPath[bannerPath.length - 1]
  }`;
              ...
              <div
                ...
                <div
                  ...
                  <div
                    ...
                    <CreateIcon fontSize="medium" style={{ color: "white" }} />
                    <div style={{ marginLeft: "10px" }}>Feedback</div>
                  </div>
                  <div
                    style={{
