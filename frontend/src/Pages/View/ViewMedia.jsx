                    ...
                    >
                        ...
                        <div className={styles.container} style={{ marginTop: "-700px", zIndex: 10 }}>
                            <div style={{ display: 'flex', flexDirection: 'column', flex: '2', alignItems: 'start', marginLeft: '5%' , marginTop:"-100px"}} >
                                ...
                                <div style={{ marginTop: "15px", width: "60%", fontSize: "17px", }}>
                                ...
                                <div className={styles.crew} >
                                    <div style={{ color: "#8197a4", fontWeight: 600 }}>Directors</div>
                                    <div style={{ color: '#79b8f3' }}>{truncate((crew.join()), 50)}</div>
                                    <div style={{ color: "#8197a4", fontWeight: 600 }}>Starring</div>
                                    <div style={{ color: '#79b8f3' }}>{truncate((cast.join()), 50)}</div>
                                    <div style={{ color: "#8197a4", fontWeight: 600 }}>Genres</div>
                                    <div style={{ color: '#79b8f3' }}>{genre.join()}</div>
                                    <div style={{ color: "#8197a4", fontWeight: 600 }}>Subtitles</div>
                                    <div style={{ color: '#79b8f3' }}>English</div>
                                    <div style={{ color: "#8197a4", fontWeight: 600 }}>Audio languages</div>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', flex: '2', marginLeft: '-50px' }}>
                                            <div style={{ display: 'flex', color: 'white', justifyContent: 'space-between', marginTop: "10px" }}>
                                                <div style={{ display: 'flex', alignItems: 'center', fontSize: '15px', color: 'white' }} >
                                                    ...
                                                    <div style={{ fontSize: '17px', marginLeft: '10px' }}>{item.title}</div>
                                                </div>
